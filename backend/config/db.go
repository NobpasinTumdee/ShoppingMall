...
func SetupDatabase() {
	...
	cards := []entity.ParkingCard{
	   	{ID: "0001", ExpiryDate: time.Now().AddDate(1, 0, 0), IsPermanent:false, UserID: 0, StoreID: 0, StatusCardID: 1, TypeParkID: 3, ParkingFeePolicyID: 3},
	   	/* {ID: "0002", ExpiryDate: time.Now().AddDate(1, 0, 0), IsPermanent:true, UserID: 2, StoreID: 0, StatusCardID: 1, TypeParkID: 3, ParkingFeePolicyID: 3},
	   	{ID: "0003", ExpiryDate: time.Now().AddDate(1, 0, 0), IsPermanent:true, UserID: 5, StoreID: 0, StatusCardID: 1, TypeParkID: 1, ParkingFeePolicyID: 1}, */
	}
