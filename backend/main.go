...
func main() {
	...
	router := r.Group("")
	{
		...
		router.GET("/get-list-parking-transaction", CarPark.GetListTransaction)
		...
		router.GET("/get-parkingpayment-by-transaction/:id", CarPark.GetParkingPaymentByTransactionID)
		...
		router.PATCH("/patch-parkingtransaction/:id",CarPark.UpdateParkingTransaction)
