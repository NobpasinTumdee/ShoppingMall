...
func main() {
	...
	router := r.Group("")
	{
		...
		router.GET("/Tax-ICONIC",user.GetTaxUserICONIC)
		//Admin
		...
		router.GET("/get-list-parking-usagecard", CarPark.GetListUsageCard)
		...
		router.GET("/get-list-type-card", CarPark.GetListTypeCard)
		//router.GET("/get-list-last-parkingusagecard", CarPark.GetListLastUsageCard)	
		...
		router.GET("/get-parking-fee-policy/:id", CarPark.GetParkingFeePolicyByID)
		...
		router.GET("/get-parkingpayment-and-usagecard-by-usagecard/:id", CarPark.GetParkingPaymentAndUsageCardByUsageCardID)
		router.GET("/get-parking-card-by-user/:id", CarPark.GetParkingCardByUserID)
		router.GET("/get-parking-zone-by-type-card/:type", CarPark.GetZoneByTypeCard)
		...
		router.GET("/get-parkingzone-daily/:id", CarPark.GetZoneDailyByZoneID)
		...
		router.PATCH("/patch-parkingzone-daily-by-zone/:id",CarPark.UpdateZoneDailyByZoneID)
		...
		router.PATCH("/delete-parkingcard/:id",CarPark.DeleteParkingCard)
