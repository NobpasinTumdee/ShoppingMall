    ...
    return(
        <>
            ...
            <div className='Mainpage'>
                <p className='ManageMainPage' onClick={handleClickToEvent}>MANAGE EVENT</p>
                <p className='ManageMainPage' onClick={handleClickToOverview}>OVERVIEW</p>
            </div>
                            ...
                            {isStore.length > 0 ? (
                                isStore.map((data,index) => (
                                    <div className='CardSubStore' key={index} >
                                        <img src={data.pic_store || PicNoStore} alt="" width={250} height={150} onClick={() => handleStoreClick(data)}/>
